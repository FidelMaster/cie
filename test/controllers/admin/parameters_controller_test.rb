...
class Admin::ParametersControllerTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test "should create admin_parameter" do
    assert_difference('Admin::Parameter.count') do
      post admin_parameters_url, params: { admin_parameter: { hour_price: @admin_parameter.hour_price } }
    end

    assert_redirected_to admin_parameter_url(Admin::Parameter.last)
  end
  ...
  test "should update admin_parameter" do
    patch admin_parameter_url(@admin_parameter), params: { admin_parameter: { hour_price: @admin_parameter.hour_price } }
    assert_redirected_to admin_parameter_url(@admin_parameter)
  end

  test "should destroy admin_parameter" do
    assert_difference('Admin::Parameter.count', -1) do
